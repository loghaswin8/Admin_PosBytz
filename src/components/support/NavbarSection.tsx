...
interface NavbarSectionProps {
  isEditing: boolean;
  navbar: Navbar | null;
  setNavbarData: (navbarData: Navbar) => void; // Add setNavbarData prop
}
...
const NavbarSection = ({ isEditing, navbar, setNavbarData }: NavbarSectionProps) => {
  ...
  const updateChanges = () => {
    ...
    setNavbarData(navbarState); // Pass the updated data to the parent component

    // Handle saving the updated data to MongoDB (handled in SupportSettings)
  };
